...
# Modified by Ayo Ayco to not install the systemd service
# ...mainly to use the CLI with a remote host using OLLAMA_HOST env var
...
configure_systemd() {
    echo "Ollama service is intentionally removed"
}
